...
class ClusteringEval():
    ...
    def __evaluate(self):
        ...
        km = KMeans(no_clusters)
        clusters = km.fit_predict(self._node_vectors)
        self._ajusted_mutual_info_score = adjusted_mutual_info_score(self._labels, clusters)
        ...
        self._normalized_mutual_info_score = normalized_mutual_info_score(self._labels, clusters)
