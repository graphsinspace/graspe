...
from embeddings.embedding_node2vec import Node2VecEmbeddingFastBase, Node2VecEmbeddingSlowBase
...
class LIDNode2VecElasticW(Node2VecEmbeddingFastBase, LIDNode2VecBase):
    ...
    def __init__(self, g, d, p=1, q=1, walk_length=80, num_walks=10, workers=10, seed=42, alpha=1):
