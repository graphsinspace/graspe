        ...
        for ds_prop in ds_props:
            data.append(
                [
                    measure,
                    ds_prop,
                    datasets[result.dataset][ds_prop],
                    getattr(result, "avg_{}".format(measure)),
                ]
            )
    for ds_prop in ds_props:
...
for ds_prop in ds_props:
    for measure in measures:
        ...
        print(
            "{} vs. {}: {}, {}, {}".format(ds_prop, measure, pearson, spearman, kendall)
        )
...
g.map_dataframe(
    sns.regplot, x="value of dataset property", y="value of measure", truncate=True
)
plt.tight_layout()
