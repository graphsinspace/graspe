...
datasets_order = ["cora", "cora_ml", "karate_club_graph", "dblp", "les_miserables_graph", "citeseer", "amazon_electronics_photo", "amazon_electronics_computers", "pubmed", "florentine_families_graph"]
...
for dataset in datasets:
    ...
    data.append(["normalized max hubness", datasets[dataset]["max_hubness_norm"], map_val])
...
print("node count vs. map: {}, {}, {}".format(pearson_nodes_cnts, spearman_nodes_cnts, kendall_nodes_cnts))
print("density vs. map: {}, {}, {}".format(pearson_densities, spearman_densities, kendall_densities))
print("hubness vs. map: {}, {}, {}".format(pearson_hubnesses, spearman_hubnesses, kendall_hubnesses))
